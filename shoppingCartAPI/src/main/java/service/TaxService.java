        ...
        public BigDecimal getTaxRate(String stateCode) {
            ...
            try {
                ...
                if (e.getStatusCode().value() == 404) {
                    throw new ResponseStatusException(HttpStatus.NOT_FOUND, "Tax not found for state " + stateCode.toUpperCase());
                } else {
                    throw new ResponseStatusException(HttpStatus.BAD_REQUEST, "There was an error getting the tax rate.");
                }
            }
        }
    }
